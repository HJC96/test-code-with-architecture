...
public class UserCreateControllerTest {
    ...
    void 사용자는_회원_가입을_할_수있고_회원가입된_사용자는_PENDING_상태이다() throws Exception {
        ...
        TestContainer testContainer = TestContainer.builder()
                .uUidHolder(()-> "aaaaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa")
                .build();
        ...
        assertThat(testContainer.userRepository.getById(1L).getCertificationCode()).isEqualTo("aaaaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
    }
}
